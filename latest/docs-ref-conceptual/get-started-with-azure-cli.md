...
Si crea prima un gruppo di risorse.  I gruppi di risorse di Azure consentono di gestire numerose risorse che si desidera raggruppare in modo logico.  Ad esempio, è possibile creare un gruppo di risorse per un'applicazione o un progetto e aggiungere una macchina virtuale, un database e un servizio rete CDN al suo interno.
...
È possibile creare una macchina virtuale Linux usando la comune immagine UbuntuLTS con due dischi di archiviazione da 10 GB e 20 GB collegati, mediante il comando seguente:
